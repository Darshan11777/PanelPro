...
export default function UserData() {
  ...
  // deleteUser check user is admin and delete requsted user
  ...
  //  adminUserData function check user is admin if yes then send all user info
  ...
  return (
    <div className="wrapper">
      <div className="adminGrid container2   text-white text-2xl grid grid-cols-4 gap-3   lg:grid-cols-2     mt-10">
        {adminCard}
      </div>
    </div>
  );
