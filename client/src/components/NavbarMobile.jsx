  ...
  return (
    <div className="wrapper  fixed top-0 left-0 w-full bg-white z-10 ">
      ...
      <div className=" hidden  w-full h-10 shadow-md sm:flex justify-between items-center container2">
        ...
        <div className={`w-full  shadow-md h-[100vh] bg-white absolute top-10 left-0  translate-x-[-100%] transition duration-300 ease-in-out ${showIcon && "show"}`} >
          <ul className="grid grid-cols-1 w-full text-black bg-[#ffffff] font-bold tracking-wider " onClick={() => setShowIcon(false)}>
