...
export default function Count() {
  ...
  {/* <h2 className="text-lg font-bold mb-4">Our Stats</h2> */}
  <div className="flex  md:grid md:grid-cols-2  justify-center mb-4  ">
    <div className="w-1/2 md:w-full  p-4 text-center">
      <h3 className="text-3xl font-bold mb-2 md:text-2lg">500+</h3>
      <p className="text-gray-600 tracking-wide ">Registered Companies</p>
    </div>
    ...
    <div className="w-1/2 md:w-full p-4 text-center">
      ...
      <p className="text-gray-600 tracking-wide">Well-known Developers</p>
    </div>
    <hr className='h-[6rem] w-[0.1rem] bg-black md:hidden'/>
    <div className="w-1/2 md:w-full  p-4 text-center">
